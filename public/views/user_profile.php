...
<?php endif; ?> 
    ...
    <section class="user-details">
        ...
        <div class="user-info">
            ...
            <p><strong>Total Comments:</strong> <?php echo isset($user['comment_count']) ? $user['comment_count'] : '0'; ?></p>
            <p><strong>Total Blogs:</strong> <?php echo isset($user['blog_count']) ? $user['blog_count'] : '0'; ?></p>
